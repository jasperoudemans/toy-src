...
function Users() {
    ...
    const determineDecrease = (username, reputation) => {
        ...
        if (checkReviews(username) === "twin") {
            ...
            return (<button className="btn btn-primary w-100" onClick={() => lowerReputation(username)}>Lower Reputation</button>);
        }
    };
    ...
    const determineIncrease = (username, reputation) => {
        ...
        if (checkReviews(username) === "twin") {
            ...
            return (<button className="btn btn-primary w-100" onClick={() => increaseReputation(username)}>Increase Reputation</button>);
        }
    }
                ...
                <div className="modal-dialog modal-xl w-100" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div>
                                {determineDecrease(username, reputation)}
                            </div>
                            <div>
                                <hr></hr>
                            </div>
                            <div>
                                {determineIncrease(username, reputation)}
                            </div>
                        </div>
                    </div>
                </div>
